...
xlabel="Valores de ϵ (r=1.E-07-1.E-08)", ylabel="Problemas resolvidos [%]", legend=:bottomleft, 
label=["MGA (dim=5)" "MGG (dim=5)" "MGA (dim=20)" "MGG (dim=20)"], framestyle = :box, seriescolor=bar_colors, dpi=1000)
